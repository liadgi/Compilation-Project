...
(load "project/constants.scm")
(load "project/functions.scm")
(load "project/label-gen.scm")
...
(define gen-prologue-assembly
	(lambda ()
		(print-line "%include \"project/scheme.s\"")
...
(define gen-make-literal-vector
	(lambda (label rest)
		(if (null? rest)
			(begin
				(print-line label ":")
				(print-tabbed-line "dq MAKE_LITERAL(T_VECTOR,0)"))
